...
Most of the fields in this dialog are the same as in the [CSV/txt import options dialog]({{% relref "observeddata" %}}#csvtxt-import-options-dialog). Please see that section for documentation on those fields. The fields specific to the paste options dialog are as follows:
