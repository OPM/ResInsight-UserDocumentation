...
If you experience issues with connection to cloud data, the local cached tokens can be deleted. The next time you access to cloud services, a browser window for authentication is displayed.
