...
- **SourSimRL** -- Available only if results from SourSimRL is imported. Displays the available imported results. See [SourSimRL Import]({{< ref "soursimrlresults.md" >}}) 
...
- **Formation Names** -- Lists only the Active Formation Names selected on the case.  ( See [Formations]({{< ref "formations.md" >}}) )
