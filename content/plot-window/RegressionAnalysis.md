...
Regression analysis curves can be created from the right-click menu for a curve in the **Plot Project Tree**. In addition to single curves, regression analysis is also supported on ensemble statistics curves and [Cross Plot]({{% relref "summarycrossplots" %}}) curves.
