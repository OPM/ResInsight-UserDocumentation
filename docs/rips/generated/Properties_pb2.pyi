...
class PropertyDataType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    FLOAT: _ClassVar[PropertyDataType]
    INTEGER: _ClassVar[PropertyDataType]
...
class PropertyRequest(_message.Message):
    __slots__ = ("case_request", "property_type", "property_name", "time_step", "grid_index", "porosity_model", "data_type")
    CASE_REQUEST_FIELD_NUMBER: _ClassVar[int]
    PROPERTY_TYPE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, case_request: _Optional[_Union[_Case_pb2.CaseRequest, _Mapping]] = ..., property_type: _Optional[_Union[PropertyType, str]] = ..., property_name: _Optional[str] = ..., time_step: _Optional[int] = ..., grid_index: _Optional[int] = ..., porosity_model: _Optional[_Union[_Case_pb2.PorosityModelType, str]] = ..., data_type: _Optional[_Union[PropertyDataType, str]] = ...) -> None: ...
