...
class ClosestFaultRequest(_message.Message):
    __slots__ = ("case_request", "point")
    CASE_REQUEST_FIELD_NUMBER: _ClassVar[int]
    POINT_FIELD_NUMBER: _ClassVar[int]
    case_request: CaseRequest
    point: _Definitions_pb2.Vec3d
    def __init__(self, case_request: _Optional[_Union[CaseRequest, _Mapping]] = ..., point: _Optional[_Union[_Definitions_pb2.Vec3d, _Mapping]] = ...) -> None: ...

class ClosestFault(_message.Message):
    __slots__ = ("fault_name", "distance", "face_name")
    FAULT_NAME_FIELD_NUMBER: _ClassVar[int]
    DISTANCE_FIELD_NUMBER: _ClassVar[int]
    FACE_NAME_FIELD_NUMBER: _ClassVar[int]
    fault_name: str
    distance: float
    face_name: str
    def __init__(self, fault_name: _Optional[str] = ..., distance: _Optional[float] = ..., face_name: _Optional[str] = ...) -> None: ...
