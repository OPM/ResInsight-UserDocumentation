...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in SimulatorTables_pb2_grpc.py depends on'
...
class WellPathStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetCompletionData = channel.unary_unary(
...
def add_WellPathServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('rips.WellPath', rpc_method_handlers)
