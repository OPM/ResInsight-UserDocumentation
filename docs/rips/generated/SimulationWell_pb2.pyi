...
class SimulationWellPerfLength(_message.Message):
    __slots__ = ("accumulated_length",)
    ACCUMULATED_LENGTH_FIELD_NUMBER: _ClassVar[int]
    accumulated_length: float
    def __init__(self, accumulated_length: _Optional[float] = ...) -> None: ...
