...
class CreateMultipleFracRequest(_message.Message):
    ...
    def __init__(self, caseId: _Optional[int] = ..., templateId: _Optional[int] = ..., wellPathNames: _Optional[_Iterable[str]] = ..., minDistFromWellTd: _Optional[float] = ..., maxFracturesPerWell: _Optional[int] = ..., topLayer: _Optional[int] = ..., baseLayer: _Optional[int] = ..., spacing: _Optional[float] = ..., action: _Optional[_Union[MultipleFracAction, str]] = ...) -> None: ...
