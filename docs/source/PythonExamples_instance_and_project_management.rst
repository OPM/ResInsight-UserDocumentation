...
.. _instance_and_project_management_command_example:

Command Example
---------------

.. literalinclude:: ../rips/PythonExamples/instance_and_project_management/command_example.py
   :language: python
   :linenos:
...
.. literalinclude:: ../rips/PythonExamples/instance_and_project_management/launch_load_case_snapshot_exit.py
   :language: python
   :linenos:
...
.. literalinclude:: ../rips/PythonExamples/instance_and_project_management/launch_with_commandline_options.py
   :language: python
   :linenos:
...
.. literalinclude:: ../rips/PythonExamples/instance_and_project_management/open_project.py
   :language: python
   :linenos:
...
.. literalinclude:: ../rips/PythonExamples/instance_and_project_management/save_project.py
   :language: python
   :linenos:
